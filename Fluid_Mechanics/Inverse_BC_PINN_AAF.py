# ********************** PHYSICS INFORMED NEURAL NETWORK - SOLVING & MODELING 2D PDE'S ******************************* #
# Author  : SIVA VIKNESH
...
def TOTAL_LOSS_FUNCTION (W1, W2, W3, W4, loss1, loss2, loss3, loss4):
	W1 = torch.log(W1**2)
	W2 = torch.log(W2**2)
	W3 = torch.log(W3**2)
	W4 = torch.log(W4**2)

	total_loss = 0.5*torch.exp(-W1)*loss1+ 0.5*torch.exp(-W2)*loss2 + 0.5*torch.exp(-W3)*loss3 + 0.5*torch.exp(-W4)*loss4
